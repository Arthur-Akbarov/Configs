; eZtt() - another tiny tooltip script:
; mouse follow
; timeout
...
; kill = 1 makes eztt sleep until the timeout and throws ExitApp then
; font = fontSize,fontStyle
; called t here for convenience purposes.. lets see how it turns out
t(text="", timeout=0, add=0, kill=0, font="s11,Tahoma")
{
	Global eZttText, eZttID, eZttExitApp
	eZttDelay := 30
