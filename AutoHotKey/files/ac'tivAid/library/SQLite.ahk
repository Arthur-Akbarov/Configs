...
$SQLITE_s_DLL = %A_ScriptDir%\Library\Tools\SQLITE3.DLL
; Default path of SQLite3.exe (A_WorkingDir)
; Required in _SQLite_SQLiteExe
$SQLITE_s_EXE = %A_ScriptDir%\Library\Tools\SQLITE3.EXE
...
_SQLite_SQLiteExe($sDBFile, $sInput, ByRef $sOutput)
{
	...
	$SQLITE_s_ERROR := ""
	$sInputFile := A_Temp "~SQLINP.TXT"
	$sOutputFile := A_Temp "~SQLOUT.TXT"
	$sOutput := ""
